...
const platinumSponsors = [
  ...
  { name: "investa.png", url: "https://investa.pl" },
  { name: "kisssoft.jpg", url: "https://kisssoft.pl" },
  { name: "komag.png", url: "https://kisssoft.pl" },
  { name: "Logo_MAN.png", url: "https://kisssoft.pl" },
  { name: "konrad composite technology.png", url: "https://kisssoft.pl" },
...
const goldSponsors = [
  ...
  { name: "eurocircuits.jpg", url: "https://eurocircuits.pl" },
  { name: "ELMAR_logo_www_duze_red.png", url: "https://eurocircuits.pl" },
  ...
  { name: "lange .png", url: "https://kaufland.pl" },
  { name: "quay.png", url: "https://kaufland.pl" },
...
const silverSponsors = [
  ...
  { name: "logo-AMA-PROFIL-COREL-_2_.png", url: "https://ataszek.pl" },
  ...
  { name: "czupryna car.png", url: "https://czuprynacar.pl" },
  { name: "cnc jurczak.png", url: "https://cnc jurczak.pl" },
  { name: "LOGO-nowe 2019.png", url: "https://cnc jurczak.pl" },
  ...
  { name: "Logo_NewTechnology (1).png", url: "https://logo_wichuworkshop.pl" },
  { name: "IEWC-Logo.png", url: "https://filipowicz pawel.png.pl" },
  { name: "smart one.png", url: "https://smart one.pl" },
  { name: "sonel.png", url: "https://smart one.pl" },
  ...
  { name: "wimarol.jpg", url: "https://wo bit.pl" },
];
...
const bronzeSponsors = [
  ...
  { name: "Easy Composites.png", url: "https://centrum przyczep.pl" },
  { name: "elgerta.png", url: "https://centrum przyczep.pl" },
  { name: "logo_cnc71.png", url: "https://logo_cnc71.pl" },
  { name: "daga.png", url: "https://daga.com.pl" },
  { name: "dremat.png", url: "https://dremat.com.pl" },
  { name: "hexagon.png", url: "https://hexagon.pl" },
  { name: "elesa+ganter.jpg", url: "https://elesa+ganter.pl" },
  { name: "hamaton.png", url: "https://hamaton.pl" },
  { name: "logo_konmet-eu.jpg", url: "https://hamaton.pl" },
  { name: "gthr.png", url: "https://hamaton.pl" },
  ...
  { name: "petrobaza.png", url: "https://power rubber.pl" },
  { name: "opony express.png", url: "https://power rubber.pl" },
  { name: "logo renex pl RED.svg", url: "https://power rubber.pl" },
